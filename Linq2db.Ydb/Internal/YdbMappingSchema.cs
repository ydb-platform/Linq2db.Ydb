...
namespace Linq2db.Ydb.Internal
{
	public sealed class YdbMappingSchema : LockedMappingSchema
	{
		...
		public YdbMappingSchema() : base("YDB")
		{
...
#region Literal generators
		...
		private static void BuildBinaryLiteral(StringBuilder stringBuilder, byte[] value)
		{
			...
			BuildHexString(stringBuilder, value);

			stringBuilder
				.Append('\'');
		}
		
		private static void BuildHexString(StringBuilder stringBuilder, byte[] value)
		{
		...
		private static void BuildIntervalLiteral(StringBuilder sb, TimeSpan value)
		{
			...
			ConvertToIso8601Interval(sb, value);
			sb.Append("')");
		}

		private static void ConvertToIso8601Interval(StringBuilder stringBuilder, TimeSpan interval)
		{
			var addTicks = 0;
